              ...
              <Controller
                ...
                render={() => (
                  <View
                    ...
                    style={
                      [RegisterFieldNames.PASSWORD, RegisterFieldNames.PHONE_NUMBER].includes(
                        field_name as any,
                      ) && viewStyles.withIcon
                    }
                  >
                    <TextInput
                      keyboardType={
                        ...
                        field_name === RegisterFieldNames.PHONE_NUMBER
                          ? 'number-pad' || 'numeric' || 'visible-password'
                          : field_name === RegisterFieldNames.PHONE_NUMBER
                            ? 'decimal-pad'
                            : 'default'
                      }
                      secureTextEntry={
                        !!(field_name === RegisterFieldNames.PASSWORD && !passwordVisibility)
                      }
                      style={
                    ...
                    />
                    {[RegisterFieldNames.PHONE_NUMBER, RegisterFieldNames.PASSWORD].includes(
                      field_name as any,
                    ) && (
                      <View key={`View-Icon-${index}`} style={viewStyles.icon}>
                        <FontAwesome.Button
                          ...
                          size={field_name === RegisterFieldNames.PASSWORD ? 14 : 18}

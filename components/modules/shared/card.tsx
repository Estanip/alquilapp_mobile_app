...
export const CardTitle = ({ children, style, ...props }: TextProps) => {
  return (
    <Text
      {...props}
      style={[tailwind`text-neutral-950 dark:text-neutral-50 text-lg font-bold`, style]}
    >
      {children}
    </Text>
  );
...
export const CardSubtitle = ({ children, style, ...props }: TextProps) => {
  return (
    <Text
      {...props}
      style={[tailwind`text-neutral-800 dark:text-neutral-200 text-sm font-bold`, style]}
    >
      {children}
    </Text>
  );
...
export const CardText = ({ children, style, ...props }: TextProps) => {
  return (
    <Text {...props} style={[tailwind`text-neutral-800 dark:text-neutral-200 text-sm`, style]}>
      {children}
    </Text>
  );
};
